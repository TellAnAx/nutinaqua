...
### General
- **check whether Scopus AI finds a paper that is somehow similar to this one!**
...
- **Permutations**
  ...
  - conduct statistical test to check whether contribution of water is significantly greater than 0
  - extract data so that probability can be calculated for occurrences of xyz
