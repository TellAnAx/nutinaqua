...
```{r eval=FALSE, fig.cap="Distribution of the expected percentage contributions of fish feed and tap water to the total nutrient input in aquaculture facilities. Data were generated through permutation."}
