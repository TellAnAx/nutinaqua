...
An amount of \SI{250}{\g} sodium bicarbonate (\ce{NaHCO3}) is recommended per \si{\kg} input of feed with \SI{350}{\g} \gls{cp} \si{\per\kg} on \gls{dm} basis [@Timmons2010]. The feed \gls{cp} content can be converted to its nitrogen content (= \SI{56}{\gkg}) via division by the Kjeldahl factor ($f_k = 6.25$). Division by the molar mass of nitrogen ($M(\ce{N}) = \SI{14.007}{\gmol}$) eventually yields the molar amount of nitrogen per \si{\kg} of feed (= \SI{4}{\mol\per\kg}).

The amount of 

Given the molar mass of \ce{NaHCO3} ($M(\ce{NaHCO3}) = \SI{84.01}{\gmol}$), and considering that $n(\ce{HCO3-}) = n(\ce{NaHCO3})$, the input of \ce{HCO3-} per \SI{250}{\g} of \ce{NaHCO3} can be calculated as $n(\ce{HCO3-}) = \frac{m(\ce{NaHCO3})}{M(\ce{NaHCO3})} = \frac{\SI{250}{\g}}{\SI{84.01}{\gmol}} = \SI{2.975}{\mol}$. 


and thus a molar input of $\frac{\SI{2.975}{\mol}}{\SI{4}{\mol\per\kg}} \approx \SI{0.75}{\mol\per\mol}$ of a single charged cation such as \ce{Na+} or \ce{K+}. This number has to be divided by 2 for double charged cations such as \ce{Ca^2+} and \ce{Mg^2+}.
