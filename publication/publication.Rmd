...
# Introduction
The production of food inevitably contributes to changes in our environment, such as global warming, pollution, and biodiversity loss [@Foley2005]. Nevertheless, the aquaculture industry will have to grow further to cover the predicted increase in demand [@FAO2022]. In the case of Europe, it would be of particular importance to promote its aquaculture industry and thus contribute to the reduction of food miles, considering that 2.5 times more seafood is currently being imported than exported [@EU2024]. At the same time, this growth must be in line with current policies such as the EU Green Deal and associated policy plans, which foster net-zero emissions and recirculation of waste streams into the material cycle to be fit for the future and ensure conservation of the environment [@EU2020a; @EU2020; @EU2019]. Against this background and the restrictive handling of water usage rights in the EU, \gls{ras} are the most promising option for (freshwater) aquaculture. 

\gls{ras} allow the highest level of control over all system inputs and outputs. Downstream utilisation can then take place in form of biorefinery processes such as biogas or volatile fatty acid production [@Choudhury2022; @Lobanov2023; @Suhr2015], or usage as fertiliser through direct field application or remineralisation [@Yogev2020; @Delaide2017; @Goddek2018; @Lobanov2023; @Monsees2017]. Another approach is \gls{imta}, the co-cultivation of extractive species that absorb non-utilised dissolved or suspended residues from the primary, fed species. \gls{imta} has the potential to reduce the environmental impact of aquaculture while increasing its output [@Klinger2012]. However, even though science shows that the stated solutions offer the potential for the eco-intensification of aquaculture, their adoption in Europe is negligible. This is due to associated economic risks and the overall complexity of such systems [@Hughes2016; @Turnsek2020]. These issues will likely also not be solved by upgrading existing \gls{ras} with other systems (e.g., hydroponics), as suggested elsewhere [@Lunda2019], because increased complexity is the source of a series of other problems, such as increased error-proneness and reduced scalability. A viable solution must, therefore, not complicate the business operations of the individual firm.

A better approach for aquaculture companies might be the close collaboration with other companies along the supply chain, also known as industrial symbiosis. Here, two or more companies use residual materials from each other’s production processes, with their sole focus remaining their core business segment. The perhaps best-known example for such industrial ecosystems is located in Kalundborg, Denmark, and has been studied in great detail over time [@Ehrenfeld1997; @Jacobsen2008]. Examples in the field of integrated aquaculture, even though at smaller scale, are the companies Vertical Agri and Biokraft A/S in Norway. Both utilise waste streams from aquaculture production sites to grow plants or produce energy.

The downside of a high degree of interdependence between production processes is that it requires material flows to be continuous, predictable and, preferably, of high quality for all parties involved. In the case of aquaculture, nutrients enter the system via the feed, the water, gas exchange, and chemicals for water management [@Nederlof2021; @Eck2019]. Optimising one of those inputs to improve waste streams for downstream valorisation requires prior knowledge about the contribution of other nutrient sources to the total input and their respective sources of variability. While few studies have addressed this issue [@Delaide2018; @Strauch2018], a thorough assessment of those factors is lacking. 

This study reviews fish feed, water, and alkalinity supplements with regards to their importance as nutrient input into closed freshwater systems. As efforts are currently being made to develop feeds that can compensate for imbalances in plant nutrients in aquaponics [@Shaw2022; @Shaw2022a; @Gebauer2023; @Shaw2024], feed formulation practices will be emphasised as well. Western and Central Europe will serve as example case due to the availability and accessibility of water analysis data by local water suppliers. The outcomes of this study will also be helpful for experts from other fields targeting at valorising aquaculture residues or reducing emissions from aquaculture systems and aid in integrating aquaculture into tomorrow’s circular economy.
...
### Water
`r results$n_wateranalysis` tap water analysis reports from `r results$n_wateranalysis_countries` countries all over Europe were collected from local authorities and water utilities in the corresponding municipalities. In addition, `r results$n_observations_water_rain` rain water analyses were collected from literature. The spatial distribution of the data is shown in Figure \ref{fig:map_water}. 

As it is common to report the value of the instrument detection limit instead of the measured value if the analyte concentration found was below the sensitivity of the measurement instrument [@ISO11843], mean average nutrient concentrations in tap water were estimated by \gls{mle}. Retaining the affected (censored) data in the dataset would have led to an overestimation of plant nutrient concentrations within the water. The estimation was done using the *cenmle()* function from the *NADA* package. Further information about the underlying algorithms can be found in the dedicated literature [@Helsel2011]. 
...
Nutrients can enter closed aquaculture systems via feed input, water exchange, the addition of chemicals, and gas exchange. However, for the nutrients mentioned in the previous section, with the exception of carbon, oxygen, and nitrogen, gas exchange is negligible as a route of entry, as most of them are not present as gases in the atmosphere. Further information with regards to gas exchange can be found elsewhere (e.g., @Boyd2019).
