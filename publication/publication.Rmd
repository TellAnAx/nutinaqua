...
In grower feeds (excluding specialty feeds), the range in which phosphorus can be found in commercial fish feeds is comparably narrow, ranging from \SIrange{7}{18}{\gpkg}. \SI{11(2)}{\gpkg} is found in the feeds on average with no statistical differences among species.
Calcium and potassium data is not reported by default.
