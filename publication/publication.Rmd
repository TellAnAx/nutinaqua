...
Aquafeeds are considered to be the most important source of nutrients in aquaculture due to continuous mass input into the system. 
- formulation of special feeds for 
  - pond aquaculture, cage aquaculture, (low in P to reduce eutrophication)
  - RAS (improved faeces properties as instable faeces cannot be removed from the system via mechanical filtration and thus produces a polluted effluent that is more expensive for discharge and has negative environmental effects)
  - aquaponics (feed with high P and K)
Formulating a specific aquaponics feed that meets the nutritional requirements of fish and leads to higher excretion of otherwise deficient plant nutrients is thus generally thought to be the most suitable approach for the development of an “off-the-shelf” nutrient delivery system that does not require additional management effort by aquaponics farmers [@Lennard2017; @Eck2019]. 

- fish and plants differ in their nutritional needs

Both fish and plants require calcium, phosphorus, magnesium, sodium, iron, copper, manganese, and zinc for functions such as the development and maintenance of the skeletal system, processes such as signal transmission, osmoregulation, as reactive centers of metalloenzymes (e.g., Haemoglobin, Chlorophyll), and others [@Lall2021; @Marschner]. However, detailed information with regards to the aquafeed inclusion levels of those nutrients is scarce. This is due to the fact that nutritional requirements of some of the mentioned substances have not yet been established for aquatic animals. Consequently, there is no target value that would have to be considered during feed formulation. Variation in the inclusion rates of such "nutritional underdogs" could thus be expected. In addition, current European regulations affecting labelling of compound feeds for aquaculture (defined by Regulation EC No. 767/2009 of the European Parliament) list only crude protein, crude fibre, crude oils and fats, crude ash, calcium, sodium and phosphorus as obligatory values to be stated on labels of commercial feeds. There is thus no incentive to analyze an aquafeed for metals other than the stated ones and as a result, the most recent publication looking into metal inclusion rates in aquafeeds dates back 40 years [@Tacon1983]. 
