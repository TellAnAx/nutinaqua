...
Dietborne toxicity of copper and zinc has not been demonstrated in fishes [@Clearwater2011]. The supply of those nutrients via the feed could thus be considered safe. However, as copper was found to be variable both in water and feeds, attempts to increase its inclusion rate in feeds might result in toxicity, either for the fed livestock or for secondary organisms.
