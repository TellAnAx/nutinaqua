...
The outcomes of the contribution analysis are shown in Figure \ref{fig:combinations}. Note that the diagrams show the respective empirical probabilities with which the percentage share of water in the total nutrient input of a nutrient lies within a given interval. Large differences in the share of the nutrient input and also in the variability of the expected share can be seen. Overall, it is not surprising to find that the proportion of nutrients supplied by the water increases with increasing amounts of supplementary water and that the proportion of nutrients is higher when tap water is used than when rainwater is used.

It can be stated that the proportion of phosphorus entering the system via tap water is negligible. The highest contribution was found not to exceed \SI{5}{\p}, thus corroborating literature [@Sugiura2018]. In some cases, however, rainwater can certainly be responsible for comparatively large amounts of phosphorus input. In \SI{40}{\p} of the scenarios, between \SI{6}{\p} and up to \SI{57}{\p} of the phosphorus originated from rainwater. These unexpectedly high values could be due to air pollution. A high temporal variability of the phosphorus concentration in rainwater was described in other studies [@Migon1999]. 

The majority of nitrogen and potassium is also not originating from water at makeup water supply of up to \SI{100}{\L\per\kg} of feed, which is typical for \gls{ras}. Contributions did not exceed around \SI{14}{\p} of nitrogen in all cases or \SI{29}{\p} of potassium in all cases. The probability that the contribution of water to the potassium input would not exceed \SI{6}{\p} was found to be \SI{60}{\p}
...
It can be seen from Figure \ref{fig:variability} that the variance for the respective nutrients is greater in the water than in the feed in almost all cases. Except for iron, copper, and zinc in scenarios were rainwater is the sole water source, the variability found in the data was at least \SI{60}{\p} greater for the water than for the feed. The greatest differences between variabilities of feed and water were found for phophorus, potassium, magnesium, and copper in case of tap water and nitrogen, phosphorus, and potassium in case of rain water. As described in \ref{sec:feed}, the low variance of nitrogen, phosphorus and calcium in the feed is likely due to set constraints during feed formulation.
