...
Iron increased by `r (1-183.5/209)*100`\si{\p}, with an average of \SI{209(237.1)}{\mgpkg} in comparison with \SI{183.5(24.7)}{\mgpkg} in the 90ies. Iron is also the nutrient with the highest variability in aquafeeds, indicated by the \gls{cv} of \SI{114}{\p} and a range from \SIrange{40}{544}{\mgpkg}.

Modern aquafeeds are `r (1-15/20)*100`\si{\p} richer in copper than old ones. The average inclusion rate increased from \SI{15(1.4)}{\mgpkg} to \SI{20(18.5)}{\mgpkg}. In the case of zinc, inclusion rates increased by `r (1-90/207)*100`\si{\p}, from \SI{90(7)}{\mgpkg} to \SI{207(126.6)}{\mgpkg}. The inclusion rates of both copper and zinc were again highly variable, with \gls{cv} of \SI{93}{\p} and \SI{61}{\p}, and ranges from \SIrange{5}{46}{\mgpkg} and \SIrange{90}{384}{\mgpkg}, respectively. 
