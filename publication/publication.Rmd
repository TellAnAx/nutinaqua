...
abstract: |
  Input routes of nutrients into aquaculture systems are generally known, but their contribution to the total nutrient input and the variability between locations remains unclear.
keywords: 
  - aquaponics
  - minerals
  - fish feed
...
Some commercial feeds were specifically formulated for aquaponics (n = 3) or pond aquaculture (n = 3).
With an average phosphorus content of \SI{12(2)}{\gpkg}, the in-depth characterised feeds do not differ from 
...
Gathered data was split into four subsets: 1) Commercial aquafeeds with available data according to EU legislation, 2) commercial aquafeeds with additional data (e.g., determined during other studies), 3) commercial aquafeeds for aquaponics purposes, and 4) experimental aquafeeds formulated for aquaponics studies. Figure XXX compares the distribution of nutrients in those subset. 

It is graspable that the ranges of those nutrients with specific target concentrations, such as phosphorus, are comparably narrow. Outliers are 
...
When considering aquafeeds as nutrient input into an aquaculture system, it is necessary to 

The variability found in the data can be traced back to three causative factors [@Tacon1983]: 
