...
The term alkalinity supplements summarizes several alkaline substances that are used to maintain a stable pH in the water [@Timmons2010]. The activity of nitrifying bacteria in the biofilter follows the overall simplified reaction equation 



Nitrification thus decreases the pH over time and, consequently, also the activity of nitrifyers [Ward2011]. Per mole of ammonium (〖"NH" 〗_4^+) that is converted to nitrate (〖"NO" 〗_3^-), two moles of protons (H^+) are released. Furthermore, it can be derived from equation (2.3) that n(〖"NH" 〗_4^+ )=n(N) and 2n(N)=n("H" ^+ ). Thus, the amount of moles that have to be neutralized based on the feed input can be calculated as 

with the molar mass M("N" )=14.007〖" g mol" 〗^(-1). Na-based substances such as sodium hydrogen carbonate (baking soda, \ce{NaHCO3}) are commonly used in aquaculture due to their high and rapid solubility at a comparably cheap price. The chemical reaction with bases such as 〖"NaHCO" 〗_3, "KOH"  or 〖"Ca(OH)" 〗_2 is eventually a simple neutralization reaction of the pattern
