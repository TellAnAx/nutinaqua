...
Nutrients can enter aquaculture systems via feed input, water exchange, the addition of chemicals, gas exchange, and natural sources such as leaf litter.

While feed is usually denoted as most important nutrient input, water is usually regarded as comparatively unimportant (see e.g., @Schmautz2016, @Sugiura2018). 

- gas exchange of no importance for substances other than carbon, oxygen, and nitrogen.
- input of biological nature is difficult to estimate. 



The focus will be placed on feed, water, and alkalinity supplements in closed and semi-open freshwater systems.


## Aquafeeds
- feed input depends on the biomass of fish in the system. 
- between 1 and 2% of biomass is usual input
