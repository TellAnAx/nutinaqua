...
# Introduction
One of the obstacles in the wider adoption of aquaponic systems, the combination of aquaculture and soilless plant production, is stated to be the rather complex management of plant nutrients within the system. Simplifying and optimizing the nutrient supply thus appears to be a reasonable way to boost aquaponics.
Nutrients enter aquaculture, and consequently also aquaponics systems through the source water, alkalinity supplements used for pH control, and the daily ration of feed for the aquatic livestock, hereinafter denoted as aquafeed [@Rakocy2006; @Eck2019; @Robaina2019]. The formulation of a specific animal feed for aquaponic systems or alkalinity supplements that add deficient plant nutrients to the system is seen as a useful approach as these substances are added to the systems on a daily base. Though, to ensure that the developed products fullfil their purpose as good as possible, it is necessary to have detailed information about average supply rates of the individual nutrients and their variability. Interestingly, information concerning this topic is largely lacking or contradictory. Thus, this study reviews the average nutrient concentrations in different nutrient sources and their variability in an attempt to exemplary identify their average contribution with respect to the total daily nutrient inputs. 
