...
### Feeds
The most important criterion for assessing the usefulness of a product for solving a problem is the reproducibility of the positive results obtained. With regard to animal feed, reproducibility can be assessed by the reproducible growth of the animals. In \gls{imta}, a conceivable criterion could be the constant amount of nutrients available for the co-cultivated organisms, regardless of the production location. However, this goal can only be achieved if the contribution of other nutrient sources to the total nutrient input is low and their temporal or spatial variation do not strongly influence the total input. These conditions are met for nitrogen, phosphorus and potassium.
