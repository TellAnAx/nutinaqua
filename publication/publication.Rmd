...
# Introduction
Compared to land animal husbandry, aquaculture faces particular challenges that are caused by the water as a habitat for the farmed animals. In water, solid excreta are directly exposed to dissolution processes and microbial degradation, as long as they are not removed by means of mechanical filtration. Meanwhile, water-soluble substances from feces decomposition, branchial or urinary excretion are highly diluted in the system water, which is eventually discharged. This has been identified as a problem from an environmental perspective (see e.g., @Sugiura2018), but also with regard to the efficient utilization of finite raw materials, as industrial downstream processes such as biogas production cannot be easily implemented in such systems. Several concepts exist where those nutrients are valorized *in situ*, such as the nutritious pond concept [@Joffre2019], fish-rice co-culture [@Halwart2004], or aquaponics [@Goddek2019]. All of these concepts combine aspects of circular economy, which is nowadays even more in the focus of the scientific community and the general public due to growing world population, climate change and resource scarcity being omnipresent in the media and addressed by policy makers worldwide, for instance in form of the EU Green Deal [@EU2015].

One factor affecting the total efficiency (*ergo*, the yield of all targeted system outputs) of these co-cultivation systems is the availability of the most limited nutrient [@Nederlof2021]. Imbalances of nutrients are considered an important issue in aquaponics [@Bittzanszky2016]. In closed and semi-open intensive systems where the majority of substance inputs stems from human activity, the approach of choice is usually to formulate a dedicated feed as simple control measure. **FROM HERE CRAPPY** However, while for instance fish rely on a dietary supply of certain nutrients, that requires the intake of feed, plants and microorganisms consume dissolved nutrients that can originate from any source. If the aim is to feed not only fish but also plants by formulating a dedicated feed, thus creating a generalized nutrient supply system, then it is necessary to consider the contribution and variability of other nutrient sources as well. Otherwise, the variability in the other nutrient sources might lead to the failure of a "generalized" nutrient supply system. if the extrema lead to a final value that is outside of a tolerable range
...
The magnesium and iron content of aquafeeds, meanwhile, appears not to have changed. The average magnesium content was \SI{2.2}{\gkg} (n = 3) in comparison with \SI{2.1}{\gkg} in past feeds. The iron content ranges around \SI{200}{\mgkg} (n = 4), even though highly variable (cv = \SI{113}{\p}), ranging from \SIrange{40}{544}{\mgkg}. However, the variability in iron was already noticed in the past [@Tacon1983].
...
### Specialty feeds
The importance of aquafeeds as nutrient input are reflected by the development of several commercial specialty feeds, for instance, for cage culture, pond aquaculture, \gls{ras} and aquaponics. 
